        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AboutDetails1 = table.Column<string>(maxLength: 1000, nullable: true),
                    AboutDetails2 = table.Column<string>(maxLength: 1000, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    WriterID = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    WriterName = table.Column<string>(maxLength: 50, nullable: true),
                    WriterSurName = table.Column<string>(maxLength: 50, nullable: true),
                    Writerİmage = table.Column<string>(maxLength: 100, nullable: true),
                    WriterMail = table.Column<string>(maxLength: 50, nullable: true),
                    WriterPassword = table.Column<string>(maxLength: 20, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    HeadingID = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    HeadingName = table.Column<string>(maxLength: 50, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ContentID = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ContentValue = table.Column<string>(maxLength: 1000, nullable: true),
